...
app.get('/about', function(req, res){                  //about라우터에서 다음을 반환한다.
    res.send('about World');
});

app.get('/ScoreData', function(req, res){                  //about라우터에서 다음을 반환한다.
    res.send('ScoreData World');
});

app.get('/ItemData', function(req, res){                  //about라우터에서 다음을 반환한다.
